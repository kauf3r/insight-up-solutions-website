# Requirements Archive: v1.0 Vercel Migration
...
- [x] **VRCL-04**: Build command produces correct Vite output in dist/public/
- [x] **VRCL-05**: Path alias @shared resolves in serverless function bundle (esbuild --alias or relative imports)
- [x] **VRCL-06**: Environment variables set on Vercel (DATABASE_URL, RESEND_API_KEY)
...
- [x] **MAIL-02**: Demo booking confirmation emails work on Vercel
- [x] **MAIL-03**: Quote/inquiry confirmation emails work on Vercel
- [x] **MAIL-04**: Admin notification emails delivered on Vercel
...
- [x] **PROD-01**: Site deployed to Vercel with working preview URL
- [x] **PROD-02**: insightupsolutions.com domain connected to Vercel
- [x] **PROD-03**: All product pages load with images
- [x] **PROD-04**: Hero video plays on homepage
- [x] **PROD-05**: All form submissions work (demo booking, quote, contact, bundle lead)
- [x] **PROD-06**: SPA routing works on page refresh (deep links don't 404)
...
| VRCL-04 | Phase 1 | Complete |
| VRCL-05 | Phase 1 | Complete |
| VRCL-06 | Phase 1 | Complete |
