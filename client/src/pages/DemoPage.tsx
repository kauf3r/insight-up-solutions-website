        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="text-demo-page-description">
              Learn more about our UAV systems first-hand. Connect with our team to discuss your specific needs and discover how our solutions can enhance your operations.
            </p>
          </div>
