...
3. **Business-content gates (blocking):**
   - Client names: RANGE/the UAS test range is NEVER named — anonymize as "an FAA-designated UAS test range on the California coast". Same discipline for any future client.
